...
public class ApiController {
    ...
    public Map<String, Object> persons(@ApiParam(required = true, value = "页码", defaultValue = "1", name = "page") @RequestParam(required = true, value = "page", defaultValue = "1") int page, @ApiParam(required = true, value = "每页数量", defaultValue = "15", name = "page_size") @RequestParam(required = true, value = "page_size", defaultValue = "15") int pageSize) {
        try {
